...
namespace BookStoreAPI.Models
{
    public class CategorySql : ICategory
    {
        ...
        public void AddCategory(Category category)
        {
            ...
            comm.CommandText = "insert into Category values('"+category.CategoryName+"','"+category.Description+"','"+category.Image+"',"+statBit+","+category.Position+",'"+DateTime.Now+"')";
        ...
        public void EditCategory(Category category)
        {
            ...
            comm.CommandText = "update Category set CategoryName='"+category.CategoryName+"',[Description]='"+category.Description+"',[Image]='"+category.Image+"',[Status]="+statBit+",Position="+category.Position+" where CategoryId="+category.CategoryId+";";
            comm.Connection = conn;
            conn.Open();
            comm.ExecuteNonQuery();
            conn.Close();
